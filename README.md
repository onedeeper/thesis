...
2. Understand what coding LLMs can and cannot do.
	...
	**LLM generated code is limited to a few test cases, `augmentations.py`(a nice to have simple module for generating test data), and helper function for loading multiprocessing arguments. If Code has been largely generated by an LLM it is commented in the code**
