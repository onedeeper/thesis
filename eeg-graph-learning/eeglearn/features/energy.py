...
def worker_init_fn(worker_id):
    """Initializer function for multiprocessing workers to ensure unique random seeds.
...
class Energy(Dataset):
    ...
    #TODO : Plot the energies generated for each band.
    def plot_energy():
        pass
    ...
    def run_permutations_parallel(self)-> None | list:
        ...
        if self.testing:
            ...
            with Pool(processes, initializer=worker_init_fn, initargs=(os.getpid(),)) as p:
                results = list(tqdm(p.starmap(self.get_permutations, starmap_args),
                                    total=len(starmap_args),
                                    desc="Computing energy band permutations"))
