"""Hyperparameter optimization for EEG self-supervised training using Optuna.

This module provides automated hyperparameter tuning for the self-supervised learning
model for EEG data. It uses Optuna's trial-based optimization to find optimal 
hyperparameters that maximize validation performance.
