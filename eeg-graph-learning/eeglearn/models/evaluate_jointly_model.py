...
from eeglearn.utils.models import (setup_label_encoder, create_graph_loaders, 
                                   calculate_class_weights, bootstrap_ci_f1) 
...
def evaluate():
    ...
    # Load model weights
    model_path = "/mnt/disk2/thesis/eeg-graph-learning/data/weights/best_models/tuur_data/tuur_data_best_model_jointly.pkl"
