...
from eeglearn.utils.models import (setup_label_encoder, create_graph_loaders, 
                                   calculate_class_weights, split_data) 
...
def evaluate():
    ...
    # Load test data
    test_graphs_path = "/Users/udeshhabaraduwa/thesis _local/thesis/eeg-graph-learning/data/graph_list/tuur_original_graph_list.pt"
