...
class Config:
    ...
    experiment_name = "jointly_tuur_data"
    optuna :bool = False
    ...
    lr = 0.02882589912251324 # <---- classification head
    weight_decay = 1.8847800744229872e-05 # <---- classification head
    drop_rate = 0.10361051574678676 # <---- classification head
    stop_at = 10
    ...
    # GCN Feature extractor parameters
    gcn_out_size = 128 
    K = 3
