...
def objective(trial):
    ...
    Config.pretrained_gcn_out_size = 64   
    Config.pretrained_k = 1              
    Config.pretrained_linear_size = 512  
    Config.pretrained_drop_rate = 0.20306923446428116  
    
    Config.linear_size = trial.suggest_categorical("hc_linear_size", [256, 512, 1024])
    Config.drop_rate = trial.suggest_float("hc_drop_rate", 0.1, 0.4)
